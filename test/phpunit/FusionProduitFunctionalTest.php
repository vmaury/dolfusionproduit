...
/**
 * \file    test/phpunit/FusionProduitFunctionalTest.php
...
/**
 * Class FusionProduitFunctionalTest
 *
 ...
 *
 * @package Testfusionproduit
 */
class FusionProduitFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modFusionProduit')->click();
		} else {
			// Disable the module
			$this->byHref('modFusionProduit')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/fusionproduit/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('fusionproduit/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/fusionproduit/admin/about.php');
		$this->authenticate();
		return $this->assertContains('fusionproduit/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('fusionproduitwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modFusionProduit_FusionProduitTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modFusionProduit_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
